...
async function proxyToGas(request, url) {
  ...
  const originalBody = request.method !== "GET" && request.method !== "HEAD" ? await request.text() : null;
...
__name(proxyToGas, "proxyToGas");
function isRedirectResponse(status) {
  return status === 301 || status === 302 || status === 303 || status === 307 || status === 308;
}
__name(isRedirectResponse, "isRedirectResponse");

// ../../Users/naoya/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../Users/naoya/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-cc1uX5/middleware-insertion-facade.js
...
// ../../Users/naoya/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-cc1uX5/middleware-loader.entry.ts
